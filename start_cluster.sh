...
./grassdb -id node1 -addr :50051 -peers :50052,:50053 > node1.log 2>&1 &
PID1=$!

echo "Starting Node 2..."
./grassdb -id node2 -addr :50052 -peers :50051,:50053 > node2.log 2>&1 &
PID2=$!

echo "Starting Node 3..."
./grassdb -id node3 -addr :50053 -peers :50051,:50052 > node3.log 2>&1 &
PID3=$!
