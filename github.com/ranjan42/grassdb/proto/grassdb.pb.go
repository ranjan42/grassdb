...
const file_proto_grassdb_proto_rawDesc = "" +
	...
	"\x03Set\x12\x13.grassdb.SetRequest\x1a\x14.grassdb.SetResponseB-Z+github.com/ranjan42/grassdb/proto;grassdbpbb\x06proto3"
...
var file_proto_grassdb_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_proto_grassdb_proto_depIdxs = []int32{
	0, // 0: grassdb.Database.Get:input_type -> grassdb.GetRequest
	2, // 1: grassdb.Database.Set:input_type -> grassdb.SetRequest
	1, // 2: grassdb.Database.Get:output_type -> grassdb.GetResponse
	3, // 3: grassdb.Database.Set:output_type -> grassdb.SetResponse
